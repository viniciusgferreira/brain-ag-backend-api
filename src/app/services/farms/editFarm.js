...
export default async function editFarm(req, res) {
	const { document, productor_name, farm_name, state, city, total_area, area_agriculture, area_vegetation, cultures, id } = req.body;
	const query = {
		...
		values: [document, productor_name, farm_name, state, city, total_area, area_agriculture, area_vegetation, cultures, id]
	};
